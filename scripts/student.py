...
class Student:
    def __init__(self,root):
        ...
        img_left=Image.open(r"C:\Users\hp\OneDrive\Desktop\Face Recognition System\Face-Recognition\photos\tr.jpg")
        ...
        btn_frame.place(x=0,y=230,width=710,height=25)
        ...
        btn_frame1.place(x=0,y=255,width=710,height=25)
        ...
        img_right=Image.open(r"C:\Users\hp\OneDrive\Desktop\Face Recognition System\Face-Recognition\photos\tr.jpg")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generateing dataset completed successfully!!!")
